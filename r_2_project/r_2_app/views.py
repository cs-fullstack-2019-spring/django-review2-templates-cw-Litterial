...
def list_song(request, song_id):
    return render(request, 'r_2_app/song_details.html', {'current_song': songs[song_id]})  #goes to song_details template

def links(request, song_id):
    return render(request,'r_2_app/links.html',{'current_song':songs[song_id]})  #goes to links template